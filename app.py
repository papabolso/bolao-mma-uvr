...
# ──────────────────────────────────────────────
# CSS — UFC theme (preto + vermelho UFC + dourado)
# ──────────────────────────────────────────────
st.markdown("""
<style>
...
.nfx-hero{
  ...
  background:
    radial-gradient(ellipse at top, rgba(210,10,10,.3) 0%, transparent 55%),
...
/* Lutas TITLE (F1/F2) — destaque dourado */
.fight-card.main{
...
<div class="nfx-hero">
  ...
  <span class="nfx-badge">It's Time! · Quem leva o bolão?</span>
</div>
""", unsafe_allow_html=True)
